...
{% include image.html file="whiteboard.JPG" description="Narrative Inquiry Process" attribution="Learning how a community partner uses data. Photo by Liz Monk, CC-BY" %}
